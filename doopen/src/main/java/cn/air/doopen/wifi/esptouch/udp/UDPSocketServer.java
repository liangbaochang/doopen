package cn.air.doopen.wifi.esptouch.udp;
...
public class UDPSocketServer {
		...
		try {
			if (isstate) {
				if (mServerSocket!=null) {
					...
					MyLog.i("UDPsoket");
					IntentFilter filter=new IntentFilter("STOP_UDPSOCKET");
					_Receiving_the_stop_broadcasting receiver=new _Receiving_the_stop_broadcasting();
					MyLog.i("注册了官博");
	...
	class _Receiving_the_stop_broadcasting extends BroadcastReceiver{
