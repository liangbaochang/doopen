...
public class DropDownListView extends ListView implements OnScrollListener {
	...
	private void initDropDownStyle() {
		...
		headerDefaultText = context.getString(R.string.drop_down_list_footer_default_text);
		headerPullText = context.getString(R.string.refreshing);
		headerReleaseText = context.getString(R.string.not_updated_yet);
		headerLoadingText = context.getString(R.string.updated_just_now);
	...
	private void initOnBottomStyle() {
		...
		footerLoadingText = context.getString(R.string.time_error);
		footerNoMoreText = context.getString(R.string.refreshing);
