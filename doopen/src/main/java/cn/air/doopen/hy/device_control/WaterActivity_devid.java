...
public class WaterActivity_devid extends Activity implements OnClickListener ,RadioName{
	...
	private void initdata() {
		...
		Intent intent1 = WaterActivity_devid.this.getIntent();
...
//				clientID = bundle.getInt("on_clientID");
	...
	public void onClick(View v) {
		...
		case R.id.water_wash_true_false_togg:// 冲洗；
			...
			shake();
			water_wash_true_false_togg.setClickable(false);
			Water_control_tool.opendevwash((byte) 2, water_wash_true_false_togg, id_devid, myBinder);
		...
		case R.id.openclose:// 开关；
			...
			Water_control_tool.opendevwash((byte) 1, openclose, id_devid, myBinder);
