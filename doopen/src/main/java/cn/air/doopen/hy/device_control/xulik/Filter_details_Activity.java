...
public class Filter_details_Activity extends Activity implements RadioName{
	...
	public void onclick(View v){
		...
		case R.id.xulik_filter_submit_btn:
			if (filter_too!=-1) {
				AlertDialog.Builder builder = new AlertDialog.Builder(Filter_details_Activity.this);
				builder.setTitle("确认复位滤芯吗？");
				builder.setNegativeButton("取消", null);
				builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int which) {
						Water_control_tool.opendevwashfu((byte)index, clientID,filter_from, myBinder);
...
//				Toast.makeText(Filter_details_Activity.this, "复位失败", Toast.LENGTH_LONG).show();
	...
	private void setdata() {
		Intent intent1 = Filter_details_Activity.this.getIntent();
